...
gongsi_path = 'D:\planself\workspace\language_tools\src'
...
def niuComment(data):
    ...
    dr.text((w - 160, new_h), '回复('+str(new_comment_count)+')  点赞('+str(news_vote_count)+')', font=create_time_font, fill="#808080")
    if (comment_flag == True):
        # 评论发布者名称 时间 地址
        c_h = 0
